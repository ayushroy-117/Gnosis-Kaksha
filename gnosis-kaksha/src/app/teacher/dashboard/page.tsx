    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-[#1A2B4A] mb-2">Teacher Portal</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card className="p-6">
            <h3 className="text-lg font-semibold text-[#1A2B4A] mb-4">Total Courses</h3>
            <p className="text-3xl font-bold text-[#1295D8]">0</p>
            <p className="text-gray-600 mt-2">Create your first course</p>
          </Card>

          <Card className="p-6">
            <h3 className="text-lg font-semibold text-[#1A2B4A] mb-4">Active Students</h3>
            <p className="text-3xl font-bold text-[#1295D8]">0</p>
          ...
          <Card className="p-6">
            ...
            <p className="text-3xl font-bold text-[#1295D8]">0</p>
            <p className="text-gray-600 mt-2">To be graded</p>
          </Card>
        </div>
        ...
        <Card className="p-8 bg-linear-to-r from-[#CDE6F7] to-[#E8F4F8]">
          ...
          <p className="text-gray-700 mb-4">
            The complete teacher portal is being built. Soon you'll be able to:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>Create and manage courses</li>
            <li>Create, update, and modify tasks/assignments</li>
            <li>Grade student submissions</li>
            <li>View student performance analytics</li>
            <li>Send messages to students</li>
            <li>Access course materials library</li>
          </ul>
        </Card>
      </div>
    </div>
